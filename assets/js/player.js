class Player {
    //constructor(id, name, position, weapon, oldWeapon, skin, action){
    constructor(id, name, position, idWeapon){
        this.id = id; //id du joueur
        this.name = name; // nom du joueur
        this.position = position; // position du joueur
        this.idWeapon = idWeapon; // arme du joueur
        this.life = maxLife; //point de vie
